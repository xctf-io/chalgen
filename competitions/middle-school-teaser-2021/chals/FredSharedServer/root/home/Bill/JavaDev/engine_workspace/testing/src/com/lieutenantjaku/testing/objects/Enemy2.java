...
public class Enemy2 extends GameObject{
	...
	public Enemy2(float x, float y, Handler handler,ObjectId id, KeyInput input,int updown,int hits) {
		super(x, y, id);
			...
			for(int i =0; i< handler.object.size(); i++) {
				GameObject tempObject = handler.object.get(i);
					if (tempObject.getId()== ObjectId.Enemy) {
						if(tempObject instanceof Enemy2) {
							tempObject=(Enemy2)tempObject;
							if(((Enemy2) tempObject).getEnemyId()==enemyId) {
