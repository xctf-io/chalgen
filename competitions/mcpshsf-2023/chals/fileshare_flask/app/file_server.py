...
root = os.path.join(os.path.dirname(os.path.realpath(__file__)), "home_folder")
key = ""
...
if __name__ == '__main__':
    ...
    app.run(bind, port, threaded=False, debug=False)